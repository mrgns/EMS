          ...
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-3">
              ...
              <form name="frm" action="registerUser" method="post">
                ...
                <div class="form-outline mb-4">
                  <input type="password" id="form3Example4cdg"  name="password1" class="form-control form-control-lg" />
                  <label class="form-label" for="form3Example4cdg">Repeat your password</label>
                </div>

                <div class="form-check d-flex justify-content-center mb-5">
                  <input class="form-check-input me-2" type="checkbox" value="true" id="form2Example3cg" />
